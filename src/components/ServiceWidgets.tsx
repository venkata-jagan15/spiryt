...
export function AiMlWidget() {
  const [text, setText] = useState("I love Spiryt! Their student developers build high-performance React code.");
...
export function ResearchPaperWidget() {
  ...
  const getCitationOutput = () => {
    if (style === "IEEE") {
      return `[1] S. Entrepreneurs, "Analyzing the impact of ${topic} in regional centers," Spiryt Journal of Engineering Technology, vol. 12, no. 3, pp. 142-156, July 2026.`;
    }
    if (style === "APA") {
      return `Entrepreneurs, S. (2026). Analyzing the impact of ${topic} in regional centers. Spiryt Journal of Engineering Technology, 12(3), 142-156.`;
    }
    return `Entrepreneurs, Student. "Analyzing the impact of ${topic} in regional centers." Spiryt Journal of Engineering Technology, vol. 12, no. 3, 2026, pp. 142-156.`;
  };
