  ...
  const faqs = [
    {
      ...
      category: "General",
      q: "Who is Spiryt?",
      a: "Spiryt is a premium digital development agency comprised of highly skilled student entrepreneurs from colleges in Andhra Pradesh, India (e.g. GMRIT, Vignan, Andhra University). We build clean, high-performance web products for local enterprises."
    },
    {
      id: "faq_2",
      category: "Technical",
    ...
    },
    {
      id: "faq_5",
      category: "General",
      q: "Where can we meet the Spiryt team in person?",
